...
//     let userId=await User.findOne({email:req.session.userEmail})
//     userId = userId._id

// console.log(code)
//     let couponData= await Coupon.find({couponName:code})
...
//     if(couponData){
//       console.log(couponData[0].expirationTime)
//       if (couponData[0].expirationTime<=Date.now) {
//     //     let error="already expired"
//     //     res.render('user/checkout',{error})
//     //   } else { 
//     //     let couponapply=false;
//     //     console.log(couponData[0].users.length);
//     //     for(let i=0;i<=couponData[0].users.length;i++)
//     //   {
//     //       if (couponData[0].users[i] == req.session.userEmail) {
//     //         couponapply = true;

//     //       }
//     //     };
//     //     if (couponapply==false) {
//     //       await Coupon.find({couponName: req.body.couponapply}, {$push: {email: req.session.userEmail}})

//     //       const discount=discount/100;
//     //   let finalAmount=orderData.finalAmount-(orderData.finalAmount*discount);
//     //   res.render('user/checkout',{finalAmount})
//     //   console.log("vishnupriya"+finalAmount);
//     //     } else {
//     //     let error="already used"
//     //     res.render('user/checkout',{error})
//     //     }
//     //   }
//     }else{
...
const checkCoupon= async (req, res) => {
  ...
  if (data.coupon) {
      Coupon
          ...
          .then((exist) => {
              console.log("user is exist or not"+exist);
              if (!exist.length) {
...
module.exports = {
  getHome,checkCoupon,forgotpassword,forgototp,forgototpverify,forgotupdate,
  cancelOrder,
  otpVerification,
  getUserProfile,
  viewOrderProducts,
